...
const UPGRADE_CONFIG = [
	...
	
	{
		...
		levels = [
			{ value = 1.25, cost = 250, unlocks = [] },
			{ value = 1.5, cost = 500, unlocks = [] },
			{ value = 2.0, cost = 1000, unlocks = [] },
			{ value = 2.5, cost = 5000, unlocks = [] },
			{ value = 3.0, cost = 10000, unlocks = [] },
			{ value = 4.0, cost = 50000, unlocks = [] },
			{ value = 5.0, cost = 100000, unlocks = [] },
	...
	levels = [
		{ value = 1.5, cost = 250, unlocks = [] },
		{ value = 2.0, cost = 500, unlocks = [] },
		{ value = 2.5, cost = 750, unlocks = [] },
		{ value = 3.0, cost = 1000, unlocks = [] },
		{ value = 4.0, cost = 1500, unlocks = [] },
		{ value = 5.0, cost = 2000, unlocks = [] },
		{ value = 7.0, cost = 3000, unlocks = [] },
		{ value = 10.0, cost = 5000, unlocks = [] },
		{ value = 15.0, cost = 15000, unlocks = [] },
		{ value = 20.0, cost = 190000, unlocks = [] },
		{ value = 25.0, cost = 240000, unlocks = [] },
		{ value = 35.0, cost = 300000, unlocks = [] },
		{ value = 45.0, cost = 370000, unlocks = [] },
